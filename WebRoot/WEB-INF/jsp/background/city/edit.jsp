   ...
   <div class="box">
     <div class="box_border">
       <div class="box_top" ><b class="pl15" >系统管理——>修改信息</b></div>
		...
		<form action="<%=request.getContextPath()%>/background/city/updateById.html" method="post" name="userForm" id="userForm">
			...
			<table class="form_table pt15 pb15 list_table" width="100%" border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="code" id="code" value="${object.code}"></input>
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="text" id="text" value="${object.text}"></input>
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="type" id="type" value="${object.type}"></input>
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="id" id="id" value="${object.id}"></input>
