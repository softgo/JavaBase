   ...
   <div class="box">
     <div class="box_border">
       ...
       <div class="box_center" style="overflow-y:scroll;align:center; height:75%;">
		<form action="<%=request.getContextPath()%>/background/mongo/addOne.html" method="post" name="userForm" id="userForm">
			<table class="form_table pt15 pb15 list_table" width="100%" border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="td_left" >
						<input class="input-text lh30" size="40" name="title" id="title" />
				...
				<tr>
					...
					<td class="td_left" >
						<input class="input-text lh30" size="40" name="by" id="by" />
				...
				<tr>
					...
					<td class="td_left" >
						<input class="input-text lh30" size="40" name="url" id="url" />
				...
				<tr>
					...
					<td class="td_left" >
						<input class="input-text lh30" size="40" name="tags" id="tags" />
				...
				<tr>
					...
					<td class="td_left" >
						<input class="input-text lh30" size="40" name="likes" id="likes" />
