...
import com.javabase.controller.SysServerInfosController;
import com.javabase.entity.ServerStatus;
import com.javabase.entity.ServerStatus.CpuInfoVo;
import com.javabase.entity.ServerStatus.DiskInfoVo;
...
public class Common {
	...
	private static void resetClasspath() {
		...
		String classpath = SysServerInfosController.class.getResource("/").getPath();
