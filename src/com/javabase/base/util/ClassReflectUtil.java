...
public class ClassReflectUtil {
	...
	public static void reflect(Object obj) {
		...
		for (Constructor<?> constructor : constructors) {
			System.out.println("构造器名称:" + constructor.getName() + "\t" + "    " + "构造器参数类型:"
		...
		for (Method method : methods) {
			System.out.println("方法名:" + method.getName() + "\t" + "方法返回类型：" + method.getReturnType() + "\t" + "方法参数类型:"
	...
	public static void main(String[] args) {
		...
		p.setName("12");
		try {
			System.out.println(setFieldValue(p, "name", "100"));
		} catch (Exception e) {
