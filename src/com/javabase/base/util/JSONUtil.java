...
public class JSONUtil{
     ...
     * @return
     */
    public static String getJsonData(String jsonStr,String key) {
    	HashMap<String, String> hashMap = getJsonMasp(jsonStr);
     ...
     * @return
     */
    public static HashMap<String, String> getJsonMasp(String jsonStr) {
    	HashMap<String, String> hashMap = new HashMap<String, String>();
    	String string = jsonStr.toString();
    	string = string.replace("}", "");
    	string = string.replace("{", "");
    	string = string.replace("\"", "");
    	String[] keys_values = string.split(",");
    	for (String strs : keys_values) {
    		String[] key_value = strs.split(":");
    		hashMap.put(key_value[0], key_value[1]);
		}
    	return hashMap;
	}
    
    public static List<String> getJsonKeys(String jsonStr) {
