package com.mongo.code.gengerate.def;
...
public class CodeResourceUtil {
	...
	private static final ResourceBundle bundle = ResourceBundle.getBundle("mongo/mongo_database");
	
	private static final ResourceBundle bundlePath = ResourceBundle.getBundle("mongo/mongo_config");
