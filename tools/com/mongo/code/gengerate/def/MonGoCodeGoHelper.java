...
public class MonGoCodeGoHelper {
	...
	private static final Logger logger = Logger.getLogger(MonGoCodeGoHelper.class.getClass().getName());
	...
	static{
		if (DRIVER==null) {
			ResourceBundle resource = ResourceBundle.getBundle("mongo/mongo_database");
