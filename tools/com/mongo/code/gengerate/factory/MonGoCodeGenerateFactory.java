package com.mongo.code.gengerate.factory;
...
import com.mongo.code.generate.CommonPageParser;
import com.mongo.code.generate.CreateBean;
import com.mongo.code.gengerate.def.CodeResourceUtil;
...
public class MonGoCodeGenerateFactory {
	...
	public static void initMySql(){
		try {
 			Properties props = PropertiesUtils.getProperties("/configPros/javabase_jdbc.properties");
 			mysqlUrl = props.getProperty("datasource.url");
 			mysqlUserName = props.getProperty("datasource.userName");
 			mysqlPassWord = props.getProperty("datasource.passWord"); 
